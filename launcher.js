...
async function deployMenu() {
  while (true) {
    ...
    console.log('  ' + C.bold + '[d]' + C.reset + ' Show rsync / scp commands');
    console.log();
    ...
    // ── [d] Show sync commands ───────────────────────────────────────────────
      ...
      console.log(hr());
      console.log(C.bold + '\n  Upload DB:' + C.reset);
      console.log('  ' + C.cyan + `rsync -avz${sh} data/portfolio.db ${conn}:${rp}/data/` + C.reset);
      console.log(C.bold + '\n  Upload project images:' + C.reset);
      console.log('  ' + C.cyan + `rsync -avz${sh} public/images/projects/ ${conn}:${rp}/public/images/projects/` + C.reset);
      console.log(C.bold + '\n  Upload logo images:' + C.reset);
      console.log('  ' + C.cyan + `rsync -avz${sh} public/images/logos/ ${conn}:${rp}/public/images/logos/` + C.reset);
      console.log(C.bold + '\n  Download DB (backup):' + C.reset);
      console.log('  ' + C.cyan + `rsync -avz${sh} ${conn}:${rp}/data/portfolio.db data/portfolio.db.bak` + C.reset);
      console.log(C.bold + '\n  Download logos (backup):' + C.reset);
      console.log('  ' + C.cyan + `rsync -avz${sh} ${conn}:${rp}/public/images/logos/ public/images/logos/` + C.reset);
      console.log(C.bold + '\n  SSH:' + C.reset);
      console.log('  ' + C.cyan + `ssh ${sc}${conn}` + C.reset);
      console.log(C.gray + '\n  Windows alternative (scp):' + C.reset);
      console.log('  ' + C.gray + `scp ${sc}data/portfolio.db ${conn}:${rp}/data/portfolio.db` + C.reset);
      console.log('  ' + C.gray + `scp ${sc}-r public/images/projects ${conn}:${rp}/public/images/` + C.reset);
      console.log('  ' + C.gray + `scp ${sc}-r public/images/logos ${conn}:${rp}/public/images/` + C.reset);
      console.log();
      await pause();
    ...
    // ── [j] Deployment checklist ─────────────────────────────────────────────
      ...
      console.log('  4. Sync content (from YOUR computer):');
      console.log(C.cyan + '       rsync -avz data/portfolio.db ' + conn + ':' + rp + '/data/' + C.reset);
      console.log(C.cyan + '       rsync -avz public/images/projects/ ' + conn + ':' + rp + '/public/images/projects/' + C.reset);
      console.log(C.cyan + '       rsync -avz public/images/logos/ ' + conn + ':' + rp + '/public/images/logos/' + C.reset + '\n');
